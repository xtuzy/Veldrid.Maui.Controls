...
namespace Veldrid.Maui.Controls.Samples.Core.Headless
{
    ...
    {
        public static string ReadEmbedAssetPath(this HeaderlessTextures drawable, string resourcePath = "foler.fileName.extention", Type type = null)
        {
            if (type == null)
            {
        ...
        public static byte[] ReadEmbedAsset(this HeaderlessTextures drawable, string resourcePath = "foler.fileName.extention", Type type = null)
        {
            resourcePath = ReadEmbedAssetPath(drawable, resourcePath);
            return drawable.ReadEmbeddedAssetBytes(resourcePath);
        }

        public static Stream ReadEmbedAssetStream(this HeaderlessTextures drawable, string resourcePath = "foler.fileName.extention", Type type = null)
        {
